...
const About = () => {
  return (
    ...
    >
      ...
      <ParagraphTitle>About Me</ParagraphTitle>
      ...
      <div className="flex flex-col items-center justify-center lg:flex-row">
        ...
        <div className="relative flex flex-col transition-all lg:ml-12 lg:mr-8">
          ...
          <p className="group mx-3 mb-3 mt-3 max-w-[35em] text-justify text-sm font-light text-white transition-all duration-300 hover:text-custom-blue-400 md:mx-0 md:mb-6 md:mt-6 md:max-w-[43em] md:text-base">
            Not so recently (2020) I started my self-taught journey studying
            front-end development and I&apos;m currently learning React/Next.js.
            Already having a basic understanding of programming (game
            development in 2019), I immersed myself in this sea of technologies
            and libraries and found myself taking a liking to the design and
