...
const SmallCard = ({ title, message, icon, topic }: SmallCardProps) => {
	return (
		<a href={`#${topic}`} className="CardLeftPixelEffect">
			<section className="z-10 flex h-[140px] w-[142px] cursor-default flex-col items-center justify-center rounded-xl border border-custom-blue-900 bg-custom-blue-900 transition-all duration-300 hover:bg-transparent xs:h-[170px] xs:w-[190px] sm:h-[200px] sm:w-[220px]">
				<FontAwesomeIcon
					icon={icon}
